...
(function () {
    ...
    const MockLLM = {
        async reply(userText, role) {
            ...
            const roleHint = {
                profesor: "Explicación breve: dividí el problema en partes simples y recordá ejemplos.",
                traductor: 'Traducción: (esto es un ejemplo) → "Hello! This is a mock translation."',
                programador: "Sugerencia técnica: preferí funciones puras y manejo de errores claro.",
                asistente: "Tip: si necesitás más contexto, podés ampliar tu pregunta.",
            }[role] || "";
